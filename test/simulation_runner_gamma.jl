...
const SIMULATION_STATUS_GAMMA_VARY_RANK_SMALL                 = true
const SIMULATION_STATUS_GAMMA_VARY_RANK_MEDIUM                = false
const SIMULATION_STATUS_GAMMA_VARY_RANK_LARGE                 = nothing

const SIMULATION_STATUS_GAMMA_VARY_MISSING_PERCENTAGE_SMALL   = false
const SIMULATION_STATUS_GAMMA_VARY_MISSING_PERCENTAGE_MEDIUM  = false
const SIMULATION_STATUS_GAMMA_VARY_MISSING_PERCENTAGE_LARGE   = nothing
