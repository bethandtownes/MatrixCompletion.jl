...
#     τ::Float64
#
#     function TuningParameters(;λFactor::Float64 = 5e-1,
#                                μFactor::Float64 = 5e-4,
#                                σ::Float64       = 0.3,
#                                τ::Float64       = 1.618)
#         new(λFactor,μFactor,σ,τ);
#     end
# end
    ...
    for iter = 1:maxiter
        ...
        if !isempty(index_tracker.Bernoulli)
            ...
            if use_autodiff == true
                ...
                binaryPartUpdate   = train(Losses.Logistic(),warm_up_bernoulli,A[index_tracker.Bernoulli],C12ObsBinary,σ;iter = gd_iter,γ=0.2);
            else
